        ...
        <Card className="shadow-xl rounded-2xl">
          {news.image_url && (
            <div className="h-64 w-full">
              <MediaDisplay bucket="faits_divers" path={news.image_url} alt={news.title} className="w-full h-full object-cover rounded-t-2xl" forceImage={true} disableLightbox={true} />
            </div>
          )}
          <CardHeader>
...
const FaitsDivers = () => {
  ...
  // Deeplink : ouverture automatique d'un article via ?articleId=
  useEffect(() => {
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="sm:max-w-[425px] bg-white">
          <DialogHeader>
            ...
            <DialogDescription>Modifiez les informations de votre article.</DialogDescription>
          </DialogHeader>
            ...
            {(editImagePreview || editFormData.image_url) && (
              <div className="col-span-4">
                {editImagePreview ? (
                  ...
                  <MediaDisplay bucket="faits_divers" path={editFormData.image_url} alt="Aperçu" className="rounded-lg mt-2 w-full max-h-40 object-cover" forceImage={true} disableLightbox={true} />
                )}
              </div>
            )}
            <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="md:flex">
                  {news.image_url && (
                    <div className="md:w-1/3 h-48 md:h-auto">
                      <MediaDisplay bucket="faits_divers" path={news.image_url} alt={news.title} className="w-full h-full object-cover" forceImage={true} disableLightbox={true} />
                    </div>
                  )}
