...
const PublicHeader = () => {
  ...
  return (
    <header
      className="fixed top-0 inset-x-0 z-50 w-full border-b border-gray-100 bg-white/95 backdrop-blur"
      style={safeAreaStyle}
    >
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate('/auth')}
              className="px-4 py-2 text-sm font-medium rounded-md bg-[#2BA84A] text-white hover:bg-[#24903f]"
            >
              Inscription
            </button>
          </div>
